...
const SubjectLearningDragDrop = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Set planning units
      setPlanningUnits(planningResponse.data);
      
      // Filter learning situations that are not assigned to planning units
      const assignedIds = planningResponse.data
        .filter(unit => unit.learning_situation)
        .map(unit => unit.learning_situation);
      
      const availableSituations = situationsResponse.data.filter(
  ...
  const handleEditSituation = (situation) => {
    ...
    // Navigate to the learning situation editor with the situation ID
    navigate(`/learning-situation/${situation.id}/edit?${queryParams.toString()}`);
  };
  ...
  if (loading) {
    return (
      <Layout schoolName={subject?.name || "Course Planner"}>
        <Page className="textbook-app">
          <div className="loading-spinner">
            <div className="spinner"></div>
            <p>Loading subject planner...</p>
          </div>
        </Page>
      </Layout>
    );
  ...
  const headerActions = (
    ...
    >
      ...
      <span>{libraryVisible ? 'Close Library' : 'Learning Situations'}</span>
    </Button>
  );
      ...
      <div className="subject-learning-editor">
        ...
        <div className="editor-navbar">
          ...
          <div className="nav-right">
            ...
            >
              ...
              {libraryVisible ? 'Close Library' : 'Learning Situations'}
            </Button>
          </div>
        </div>
        ...
        <div className="editor-content">
          ...
          >
            ...
            <div className="textbook-page">
              <div className="chapter-title">
                ...
                <p className="chapter-subtitle">Drag learning situations from the library to plan your course</p>
              </div>
                ...
                {unitsToDisplay.map((unit) => {
                  ...
                  return situation ? (
                    ...
                    <Card
                      ...
                      title={`Unit ${index + 1}: ${situation.title}`}
                      headerActions={
                    ...
                    >
                      <div className="unit-empty-placeholder">
                        <p className="unit-placeholder">
                          Drag a learning situation here
                        </p>
                        <Button 
                          variant="secondary"
                          onClick={() => handleCreateNew(index)}
                          title="Create New Learning Situation for this Unit"
            ...
            <div className={`textbook-library ${libraryVisible ? 'visible' : ''}`}>
              ...
              <div className="library-search">
                <input
                  type="text"
                  placeholder="Search learning situations..."
                  value={searchQuery}
              ...
              <div className="library-items">
                {filteredSituations.length > 0 ? (
                  ...
                  <div className="library-empty">
                    ...
                    <p>Create new ones with the + button.</p>
                  </div>
                )}
              </div>
              ...
              <div className="library-footer">
                <Button 
                  ...
                  title="Create New Learning Situation"
          ...
          <LearningSituationModal
            ...
            fixedSubject={true}
            modalTitle={creatingForUnitIndex !== null ? `Create Learning Situation for Unit ${creatingForUnitIndex + 1}` : 'Create Learning Situation'}
          />
