...
import enPlanner from './resources/en/planner.json';
import enContent from './resources/en/content.json';
...
import esPlanner from './resources/es/planner.json';
import esContent from './resources/es/content.json';
import esSubjects from './resources/es/subjects.json';
...
const resources = {
  ...
  ca: {
    ...
    subjects: esSubjects, // Fallback to Spanish for now
  },
};
